...
class RobotChassesSpinAction : public BT::RosTopicPubNode<rm_decision_interfaces::msg::RobotControl>
{
public:
  RobotChassesSpinAction(
  ...
  {
    return {BT::InputPort<float>("chassis_spin_vel")};
  }
};
}  // namespace rm_behavior_tree
